...
export default function SettingsPage() {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full">
      ...
      >
        <div className="w-16 h-16 rounded-2xl bg-slate-500/20 text-slate-400 flex items-center justify-center mb-6">
        ...
        <p className="text-slate-400 mb-8">Access to core system parameters is currently locked. Authentication level insufficient.</p>
