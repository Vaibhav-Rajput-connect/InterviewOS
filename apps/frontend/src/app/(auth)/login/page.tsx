          ...
          {!isUnlocked ? (
            ...
            >
              <div className="flex flex-col items-center mb-10">
                ...
                <h1 className="text-3xl font-display font-bold text-white tracking-tight">Access Port</h1>
                <p className="text-slate-400 text-sm mt-2 font-mono">SYSTEM_LOGIN_REQUIRED</p>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end">
                    <Link href="/forgot-password" className="text-xs text-slate-400 hover:text-red-400 transition-colors">
                      Bypass Security?
                    </Link>
                  </div>
                </div>
              ...
              <p className="text-center text-sm text-slate-400 mt-8">
                Unregistered entity? <Link href="/signup" className="text-white hover:text-red-400 font-medium transition-colors border-b border-white/20 pb-0.5 hover:border-red-400/50">Request Access</Link>
              </p>
            </motion.div>
          ) : (
            <motion.div
            ...
            >
              <div className="w-20 h-20 rounded-full border-2 border-red-500 border-t-transparent animate-spin mb-6" />
              <h2 className="text-2xl font-display font-bold text-white mb-2">Access Granted</h2>
              <p className="text-red-400 font-mono text-sm animate-pulse">Entering InterviewOS...</p>
            </motion.div>
          )}
        </AnimatePresence>
      </motion.div>
