...
/**
 * Custom SVG icons for features — lightweight, no external icon library needed.
 */
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" className={className}>
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <circle cx="16" cy="16" r="3" fill="#ef4444" filter="url(#logo-glow)" />
    </svg>
  );
}

/** Map icon names from constants to components */
